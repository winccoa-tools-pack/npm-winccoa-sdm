...
export function registerTools(server, context) {
    ...
    server.tool("archive-delete", `Delete archive configuration from a datapoint element in WinCC OA.
    ...
    `, {
        ...
        try {
            ...
            if (!hasConfig) {
                return createErrorResponse(`No archive configuration exists for ${dpe}`);
            }
...
//# sourceMappingURL=archive_delete.js.map