...
export function registerTools(server, context) {
    ...
    server.tool("pv-range-delete", `Delete pv_range (min/max) configuration from a datapoint element in WinCC OA.
    ...
    `, {
        ...
        try {
            ...
            if (!hasConfig) {
                return createErrorResponse(`No pv_range configuration exists for ${dpe}`);
            }
...
//# sourceMappingURL=pv_range_delete.js.map