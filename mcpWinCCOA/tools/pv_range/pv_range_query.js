 ...
 */
async function queryRangeConfig(winccoa, dpe) {
    try {
...
export function registerTools(server, context) {
    ...
    server.tool("pv-range-query", `Query existing pv_range (min/max) configuration from a datapoint element in WinCC OA.
...
//# sourceMappingURL=pv_range_query.js.map