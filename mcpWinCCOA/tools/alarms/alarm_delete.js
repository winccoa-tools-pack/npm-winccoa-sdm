...
export function registerTools(server, context) {
    ...
    server.tool("alarm-delete", `Delete alarm configuration from a datapoint element in WinCC OA.
    ...
    `, {
        ...
        try {
            ...
            if (!hasConfig) {
                return createErrorResponse(`No alert configuration exists for ${dpe}`);
            }
...
//# sourceMappingURL=alarm_delete.js.map