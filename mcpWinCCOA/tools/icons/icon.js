...
export function registerTools(server, context) {
    ...
    // ==================== CREATE CUSTOM ICON ====================
    server.tool('create-custom-icon', `Create a custom SVG icon for dashboard widgets.
...
After creating the icon, use it in a widget header or footer:
{
  ...
  "headerTitle": "Production Line 1"
    ...
    // ==================== LIST CUSTOM ICONS ====================
    server.tool('list-custom-icons', `List all available custom icons in /data/WebUI/icons/.
...
Call this tool to see all available custom icons, then use the path in edit-widget:
{
  ...
  "titleIcon": "/data/WebUI/icons/your-icon.svg"
    ...
    // ==================== DELETE CUSTOM ICON ====================
    server.tool('delete-custom-icon', `Delete a custom icon from /data/WebUI/icons/.
...
Example:
{
  "name": "my-icon.svg"
    ...
    server.tool('list-ix-icons', `Search and filter through 1,407 built-in Siemens IX icons.
