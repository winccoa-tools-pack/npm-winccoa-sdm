 ...
 */
const layoutSchema = z.preprocess((val) => {
...
export function registerTools(server, context) {
    ...
    // ==================== ADD WIDGET ====================
    server.tool('add-widget', `Add a widget to a dashboard.
...
- Example explicit layout: {"x": 25, "y": 0, "cols": 25, "rows": 13} places widget in right half`, {
        ...
        try {
            const { dashboardId, type, title, dataPoint, dataPoints, dataPointsDescriptions, rangeSettings, timeRange, layout, 
            // Appearance
            titleIcon, headerTitle, titleAlignment, subtitleIcon, footerTitle, subtitleAlignment, backgroundColor, borderColor, showFullscreenButton, linkTitle, linkOpenInNewTab, 
            // Progress bar
            color, size, unit, format, min, max, showRange, isAbsolute, alertRanges, 
            // Bar chart
            yAxisName, yAxisUnit, yAxisColor, range, isStacked, isHorizontal, showTooltip, showLegend, legendPosition } = params;
    ...
    // ==================== EDIT WIDGET ====================
    server.tool('edit-widget', `Edit a widget on a dashboard.
...
Example 4 - Change trend time range and show legend:
{
  ...
  "showLegend": true
        ...
        try {
            let { dashboardId, widgetIdentifier, title, layout, titleIcon, headerTitle, titleAlignment, subtitleIcon, footerTitle, subtitleAlignment, backgroundColor, borderColor, showFullscreenButton, linkTitle, linkOpenInNewTab, 
            // Widget-specific settings
            unit, format, name, color, showTooltip, min, max, rangeSettings, timeRange, showLegend, dataPoints, yAxisName, yAxisUnit, yAxisColor, range, isStacked, isHorizontal, legendPosition } = params;
    ...
    // ==================== DELETE WIDGET ====================
    server.tool('delete-widget', `Delete a widget from a dashboard.
...
Example:
{
  ...
  "widgetIdentifier": {"index": 0}
    ...
    // ==================== LIST WIDGETS ====================
    server.tool('list-widgets', `List all widgets on a dashboard.
