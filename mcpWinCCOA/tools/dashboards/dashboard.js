...
export function registerTools(server, context) {
    ...
    // ==================== CREATE DASHBOARD ====================
    server.tool('create-dashboard', `Create a new dashboard in WinCC OA.
...
Example:
{
  ...
  "createdBy": "admin"
    ...
    // ==================== EDIT DASHBOARD ====================
    server.tool('edit-dashboard', `Edit an existing dashboard's properties.
...
Example:
{
  ...
  "description": "Updated description"
    ...
    }, async ({ dashboardId, name, description }) => {
        try {
            if (!name && !description) {
    ...
    // ==================== DELETE DASHBOARD ====================
    server.tool('delete-dashboard', `Delete a dashboard.
...
Example:
{
  "dashboardId": "_Dashboard_000001"
    ...
    // ==================== LIST DASHBOARDS ====================
    server.tool('list-dashboards', `List all dashboards in the system.
