 ...
 */
async function queryCommonConfig(winccoa, dpe) {
    try {
...
export function registerTools(server, context) {
    ...
    server.tool("common-query", `Query existing common config attributes (description, alias, format, unit) from a datapoint element in WinCC OA.
...
//# sourceMappingURL=common_query.js.map