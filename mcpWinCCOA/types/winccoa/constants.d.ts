 ...
 */
export declare enum DpConfigType {
    /** No config */
    DPCONFIG_NONE = 0,
    /** Archive config */
 ...
 */
export declare enum DpAddressDirection {
    /** Undefined */
 ...
 */
export declare enum DpAlertAckType {
    /** Single acknowledge */
 ...
 * Alert Range Types
 */
export declare enum DpAlertRangeType {
    /** No range type */
 ...
 */
export declare enum DpArchiveProcessType {
    /** No archiving */
